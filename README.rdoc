...
Forked from {bitcoin-ruby}[https://github.com/lian/bitcoin-ruby]
This is a stripped version of ruby library for interacting with the bitcoin protocol/network.
